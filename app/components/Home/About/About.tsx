...
const About = () => {
  ...
  return (
    <div className="pt-16 pb-16" id="about-me">
      <SectionHeading >About Me</SectionHeading>

      <div className="w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-20">
        {/* Text Content */}
        <div>
          <h1 data-aos="zoom-out" className="text-bg text-[26px] sm:text-3xl md:text-4xl lg:text-5xl font-bold text-black">
            Web Developer & Data Explorer
          </h1>
          <p data-aos="zoom-out" className="mt-6 text-base">
